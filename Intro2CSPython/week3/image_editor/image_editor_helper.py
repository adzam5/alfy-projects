...
def from_lists_to_pil(image_as_lists):
    """
...
def display_image(image):
    ...
    """
    from_pil_to_list(image).show()


def image_saver(image, filename):
    """
    ...
    """
    from_lists_to_pil(image).save(filename)